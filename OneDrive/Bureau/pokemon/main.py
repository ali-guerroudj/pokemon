...
def main():
    ...
    rect_pokedex = button_pokedex_resized.get_rect(topleft=(start_x + button_width * 2 + spacing * 2,
                                                            SCREEN_HEIGHT - button_pokedex_resized.get_rect().height - 40))
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if rect_play.collidepoint(event.pos):
                    ...
                    pokedex.run(screen)  # Appel de la fonction pour ouvrir le Pokédex
